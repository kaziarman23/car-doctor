...
const Bookings = () => {
  ...
  // const url = `https://car-doctor-server-livid-theta.vercel.app/bookings?email=${user.email}`;
  const url = `/bookings?email=${user.email}`;

  useEffect(() => {
    // calling data with custom axios hook
    axiosSecure
      .get(url)
      .then((res) => {
    ...
    // calling data with axios
    // axios
    //   .get(url, { withCredentials: true })
    //   .then((res) => setBookings(res.data));

    // calling data with fetch
    // fetch(url)
    //   .then((res) => res.json())
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://car-doctor-server-livid-theta.vercel.app/bookings/${id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
